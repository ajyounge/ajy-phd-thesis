...
Virtualization, in its most pure form, refers to the process of creating virtual abstraction to hardware platforms, operating systems, or software resources. Viurtualization enables the creation of 1 or more virtual machines (VMs) that are run concurrently on the same operating environment, be it hardware or some higher software. As virtualization is, in general, just another form of abstraction, there are in fact many levels to virtualization that exist. 
