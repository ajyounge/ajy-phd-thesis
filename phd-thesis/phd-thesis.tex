...
%AJY: IU library hates headers, so comment out headers
\usepackage{fancyhdr}
\fancyhf{}
\cfoot{\thepage}
...
%Fixes font sizes of TOC and LOF 
\renewcommand{\contentsname}{\normalfont\normalsize\bfseries Table of Contents}
\renewcommand{\listfigurename}{\normalfont\normalsize\bfseries List of Figures}


%This fixes the IU Library's requirement to keep all fonts at 12pt, including section names
\usepackage{titlesec}
\titleformat{\part}[display]
  {\normalfont\normalsize\bfseries}
  {\parttitlename\ \thepart}{12pt}{\normalsize}
\titleformat{\chapter}[display]
  {\normalfont\normalsize\bfseries}
  {\chaptertitlename\ \thechapter}{12pt}{\normalsize}
\titleformat{\section}[hang]
  {\normalfont\normalsize\bfseries}
  {}{0em}{\thesection\hspace{0.6em}}
\titleformat{\subsection}[hang]
  {\normalfont\normalsize\bfseries}
  {}{0em}{\thesubsection\hspace{0.6em}}

% ------------------------- Fill in these fields for the preliminary pages ----------------------------
%
% For Senior and honors this is the year and month that you submit the thesis
% For Masters and PhD, this is your graduation date
\Year{2017} \Month{February} \Author{Andrew J. Younge}
...
%Hage page numbers lower center, but no headers
\pagestyle{plain}
...
\newcommand{\TODO}[1]{{\color{yellow}\em  TODO: #1}}
...
%Enable line numbers for editing purposes
%\linenumbers
...
%Add a line for the CV (appended separately) that doesn't include page numbers
\cftaddtitleline{toc}{chapter}{Cirriculum Vitae}{}

%\phantomsection \addcontentsline{toc}{chapter}{Cirriculum Vitae} 
